                ...
                <div className='col-12 col-md-9'>
                    <Form onSubmit={this.handleSubmit}>
                        ...
                        <FormGroup row>
                            ...
                            <Col md={10}>
                                <Input type="email" id="email" name="email" placeholder="Email Id" value={this.state.email} valid={errors.email===''} invalid={errors.email!==''} onBlur={this.handleBlur('email')} onChange={this.handleInputChange}></Input>
                        ...
                        <FormGroup row>
                            ...
                            {/* <Label htmlFor="firstname" md={2}>First Name</Label>
                            <Col md={10}>
                                <Input type="text" id="firstname" name="firstname" placeholder="First Name" value={this.state.firstname}></Input>
                            </Col> */}
                        </FormGroup>
                        ...
                        <FormGroup row>
                            ...
                            {/* <Col md={{size:3, offset:1}}>
                                <Button  color="secondary" onChange={this.handleReset}>Reset</Button>
                            </Col> */}
                        </FormGroup>
                    </Form>
                </div>
